...
<div style="background:#f0f4f0;min-height:100vh;padding:2rem 1rem;">
  <div class="container" style="max-width:1100px;">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
      ...
      <a href="{{ route('admin.routes.create') }}" class="btn"
      ...
      <table class="table mb-0">
        <thead style="background:#fafafa;">
          <tr>
            ...
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
                       letter-spacing:0.5px;border:none;padding:12px 1rem;">From</th>
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
                       letter-spacing:0.5px;border:none;padding:12px 1rem;">To</th>
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
                       letter-spacing:0.5px;border:none;padding:12px 1rem;">Status</th>
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
              ...
              <td style="padding:12px 1rem;border-color:#f1efef;">
                @if($route->status === 'active')
                  <span style="font-size:11px;padding:3px 10px;border-radius:20px;
                               background:#E1F5EE;color:#085041;font-weight:500;">
                    Active
                  </span>
                @else
                  <span style="font-size:11px;padding:3px 10px;border-radius:20px;
                               background:#f1efef;color:#888780;font-weight:500;">
                    Suspended
                  </span>
                @endif
              </td>
            ...
            <tr>
              <td colspan="5"
                  style="text-align:center;padding:2rem;color:#888780;font-size:14px;
                         border:none;">
                No routes found. <a href="{{ route('admin.routes.create') }}"
