...
<div style="background:#f0f4f0;min-height:100vh;padding:2rem 1rem;">
  <div class="container" style="max-width:1100px;">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
      ...
      <a href="{{ route('admin.stops.create') }}" class="btn"
      ...
      <table class="table mb-0">
        <thead style="background:#fafafa;">
          <tr>
            ...
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
                       letter-spacing:0.5px;border:none;padding:12px 1rem;">Latitude</th>
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
                       letter-spacing:0.5px;border:none;padding:12px 1rem;">Longitude</th>
            <th style="font-size:11px;color:#888780;font-weight:500;text-transform:uppercase;
          ...
          @forelse($stops as $stop)
            <tr>
              ...
              <td style="padding:12px 1rem;border-color:#f1efef;text-align:right;">
                ...
                <form method="POST" action="{{ route('admin.stops.destroy', $stop) }}"
            ...
            <tr>
              <td colspan="4"
                  style="text-align:center;padding:2rem;color:#888780;font-size:14px;
                         border:none;">
                No stops found. <a href="{{ route('admin.stops.create') }}"
