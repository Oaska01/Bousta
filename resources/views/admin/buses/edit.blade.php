...
<div style="background:#f0f4f0;min-height:100vh;padding:2rem 1rem;">
  <div class="container" style="max-width:640px;">
    ...
    <div class="mb-4">
      <h1 style="font-size:22px;font-weight:500;color:#085041;margin-bottom:4px;">Edit bus</h1>
      <p style="font-size:13px;color:#888780;margin:0;">Update bus information</p>
    </div>
      ...
      <form method="POST" action="{{ route('admin.buses.update', $bus) }}">
        ...
        <div class="mb-3">
          ...
          <input type="number" id="capacity" name="capacity" min="1" max="100"
                 ...
                 value="{{ old('capacity', $bus->capacity) }}" required>
        ...
        <div class="mb-4">
          ...
          <select id="status" name="status" class="form-select @error('status') is-invalid @enderror" required>
            ...
            <option value="retired" {{ old('status', $bus->status) === 'retired' ? 'selected' : '' }}>Retired</option>
          </select>
